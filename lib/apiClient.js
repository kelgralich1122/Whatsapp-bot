...
const DEFAULT_SYSTEM_PROMPT = 'You are KevooBot, a helpful, friendly WhatsApp assistant. Keep replies concise and useful. Use emojis sparingly.';

/**
 * Chat with AI via Groq → OpenRouter fallback
 */
export async function chatAI(userMessage, customSystemPrompt = null) {
